      ...
      <div className="section contact-form">
        ...
        <div>
          <form className="contact-form-cantainer">
            ...
            <div className="form-fild">
              <label htmlFor="subject">Your Subject <sup>*</sup></label>
              <input type="text" name="subject" id="subject" placeholder="Your subject here" required/>
            </div>
            <div className="form-fild">
              <label htmlFor="mobile">Contact Number <sup>*</sup></label>
              <input type="text" name="mobile" id="mobile" placeholder="Your phone number" required/>
            </div>
            <div className="form-fild form-textarea">
              <label htmlFor="message">Message <sup>*</sup></label>
              <textarea name="" id="message" cols="30" rows="4" required placeholder="Tell us few word"></textarea>
            </div>
